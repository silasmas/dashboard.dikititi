...
<div>
    ...
    <input type="file" id="video-upload" accept="video/AVI,video/avi,video/mp4,video/quicktime" class="form-control" />
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        input.addEventListener('change', async function() {
            ...
            if (!['video/AVI','video/avi','video/mp4', 'video/quicktime'].includes(file.type)) {
                alert('⚠️ Format non supporté.');
                return;
            }
